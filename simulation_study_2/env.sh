...
export SIMULATION_STUDY_SCRIPT_PATH="/gpfs/home/susmah01/efficient_penalized_estimation_paper/simulation_study_2/simulation.R"

# Directory to cache intermediate results (e.g., per-task output)
export SIMULATION_CACHE_PATH="/gpfs/scratch/susmah01/efficient_penalized_estimation_paper/cache_2"
...
export SIMULATION_RESULTS_PATH="/gpfs/home/susmah01/efficient_penalized_estimation_paper/simulation_study_2/results"

# === SLURM job configuration ===

# Name of the SLURM job (appears in job monitoring commands)
export JOB_NAME="sim2"
